...
HRESULT FakedSetIndices()
{
	...
	if (ib_id == -1)
		return cur_device->SetIndices(NULL);
...
HRESULT FakedSetVertexDeclaration()
{
	...
	if (id == -1)
		return cur_device->SetVertexDeclaration(NULL);
...
HRESULT FakedSetVertexShader()
{
	...
	if (id == -1)
		return cur_device->SetVertexShader(NULL);
...
HRESULT FakedSetPixelShader()
{
	...
	if (id == -1)
		return cur_device->SetPixelShader(NULL);
...
HRESULT FakedSetDepthStencilSurface()
{
	...
	if (sfid == -1)
		return cur_device->SetDepthStencilSurface(NULL);
